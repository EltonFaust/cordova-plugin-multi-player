...
public class PCMFeed implements Runnable, AudioTrack.OnPlaybackPositionUpdateListener {
     ...
     */
    protected PCMFeed( int sampleRate, int channels, int bufferSizeInBytes, PlayerCallback playerCallback, int trackStreamType ) {
        this.sampleRate = sampleRate;
        this.channels = channels;
        this.bufferSizeInBytes = bufferSizeInBytes;
        this.bufferSizeInMs = bytesToMs( bufferSizeInBytes, sampleRate, channels );
        this.playerCallback = playerCallback;
        this.setTrackStreamType(trackStreamType);
    }
    ...
    protected void setTrackStreamType(int trackStreamType) {
        if (trackStreamType != AudioManager.STREAM_MUSIC && trackStreamType != AudioManager.STREAM_ALARM) {
            trackStreamType = AudioManager.STREAM_MUSIC;
        }

        this.trackStreamType = trackStreamType;
    }
}
